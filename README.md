...
## 🛡 Installation
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/amanqs/FileSharing)</br>
...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/amanqs/FileSharing/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/amanqs/FileSharing/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
...
## 🏷 Support   
- Follow Channel [@amwangs](https://t.me/amwangs) untuk info Update bot 
- Gabung Group [@amangsupportgrup](https://t.me/amangsupportgrup) untuk diskusi, pelaporan bug, dan bantuan tentang FileSharing.

## 👨🏻‍💻 Credits

-  [Dan](https://github.com/delivrance) for [Pyrogram](https://github.com/pyrogram/pyrogram)
-  [Amang](https://github.com/amanqs) for [File-Sharing-Man](https://github.com/amanqs/FileSharing)
...
[FILE-SHARING-BOT](https://github.com/amanqs/FileSharing/) is Free Software: You can use, study share and improve it at your
